...
{
    UnaryResult<DBResult> Remove(string type, byte[] bytes, string connectionId, int? commandTimeout = null);

    UnaryResult<DBResult> Save(string type, byte[] bytes, string connectionId, int? commandTimeout = null);
